...
export const Logo = ({ variant = "full", theme = "light", className }) => {
  ...
  return (
    <Link
      ...
      aria-label="Prince Pipes & Fittings Home"
    >
      <div className="relative w-14 h-14 md:w-16 md:h-16 flex-shrink-0">
        <Image
          src="/logo/ppfIcon.webp"
      ...
      {variant !== "icon" && (
        <div className="flex flex-col justify-center leading-none uppercase font-heading">
          <span
            className={cn(
              "font-bold text-md md:text-3xl tracking-[0.12em] mb-0.5",
          ...
          <span
            className={cn(
              "font-bold text-[10px] md:text-xs tracking-[0.15em]",
